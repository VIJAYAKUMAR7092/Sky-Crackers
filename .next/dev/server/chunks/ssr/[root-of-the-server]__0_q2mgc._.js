...
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$cms$2f$cms$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function generateMetadata() {
    const [seo, website] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$cms$2f$cms$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSEOSettings"])("global"),
...
if ("TURBOPACK compile-time truthy", 1) globalThis.prismaGlobalV2 = prisma;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
"[project]/lib/services/cms/cms.service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getWebsiteSettings() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].websiteSettings.upsert({
        where: {
            id: 'global'
        },
        update: {},
...
async function updateWebsiteSettings(data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].websiteSettings.upsert({
        where: {
            id: 'global'
        },
...
async function getHeroBanners(activeOnly = false) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].heroBanner.findMany({
        where: activeOnly ? {
            active: true
        } : undefined,
        orderBy: {
...
async function createHeroBanner(data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].heroBanner.create({
        data
    });
}
async function updateHeroBanner(id, data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].heroBanner.update({
        where: {
            id
        },
        data
...
async function deleteHeroBanner(id) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].heroBanner.delete({
        where: {
            id
        }
    });
}
async function getVideoContent(activeOnly = false) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].videoContent.findMany({
        where: activeOnly ? {
            active: true
        } : undefined,
        orderBy: {
...
async function createVideoContent(data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].videoContent.create({
        data
    });
}
async function updateVideoContent(id, data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].videoContent.update({
        where: {
            id
        },
        data
...
async function deleteVideoContent(id) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].videoContent.delete({
        where: {
            id
        }
    });
}
async function getStaticPages(activeOnly = false) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].staticPage.findMany({
        where: activeOnly ? {
            active: true
        } : undefined,
        orderBy: {
...
async function getStaticPageBySlug(slug) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].staticPage.findUnique({
        where: {
            slug
        }
    });
...
async function createStaticPage(data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].staticPage.create({
        data
    });
}
async function updateStaticPage(id, data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].staticPage.update({
        where: {
            id
        },
        data
...
async function deleteStaticPage(id) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].staticPage.delete({
        where: {
            id
        }
    });
}
async function getSEOSettings(path) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].sEOSettings.findUnique({
        where: {
            path
        }
    });
}
async function getAllSEOSettings() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].sEOSettings.findMany();
}
async function upsertSEOSettings(path, data) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].sEOSettings.upsert({
        where: {
            path
        },
        update: data,
...
async function deleteSEOSettings(id) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].sEOSettings.delete({
        where: {
            id
        }
    });
}
async function getTestimonials(activeOnly = false) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].review.findMany({
        where: {
            isTestimonial: true,
            ...activeOnly ? {
                isApproved: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_q2mgc._.js.map