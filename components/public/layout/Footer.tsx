            ...
            <div className="grid grid-cols-2 gap-2 md:gap-4 lg:grid-cols-1">
              ...
              <ul className="space-y-1.5 md:space-y-3">
                ...
                <li className="flex items-center gap-2 md:gap-3">
                  ...
                  <a href={`tel:${settings?.primaryPhone || "+916383828284"}`} className="text-[11px] md:text-sm font-bold text-white hover:text-yellow-400 transition-colors duration-200 break-all">
                    {settings?.primaryPhone || "+91 63838 28284"}
                  </a>
                </li>
                <li className="flex items-center gap-2 md:gap-3">
                  <Phone className="h-3 w-3 md:h-4 md:w-4 text-yellow-400 shrink-0" />
