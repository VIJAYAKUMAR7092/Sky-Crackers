...
export function TopNavbar({ onMenuClick, adminName, adminRole, unreadCount = 0 }: TopNavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-border bg-background px-4 backdrop-blur-xl sm:px-6 shadow-sm">
      ...
      <div className="flex items-center gap-2 sm:gap-4 relative">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {/* Dropdown Menu */}
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl bg-popover shadow-lg ring-1 ring-black/5 dark:ring-white/10 focus:outline-none divide-y divide-border border border-border animate-in slide-in-from-top-2">
