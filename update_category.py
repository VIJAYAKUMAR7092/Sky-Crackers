...
# I will replace the entire file to add up/down functionality
...
# Update page.tsx to default limit to 100 instead of 10
page_path = 'app/admin/(dashboard)/categories/page.tsx'
with open(page_path, 'r', encoding='utf-8') as f:
    page_content = f.read()

page_content = page_content.replace('limit: typeof resolvedParams.limit === \'string\' ? Number(resolvedParams.limit) : 10,',
                                    'limit: typeof resolvedParams.limit === \'string\' ? Number(resolvedParams.limit) : 100,')

with open(page_path, 'w', encoding='utf-8') as f:
    f.write(page_content)

print("Updated CategoryClient.tsx and page.tsx")
